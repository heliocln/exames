...
public class PrincipalServiceLocator extends org.apache.axis.client.Service implements servicos.PrincipalService {
    ...
    private java.lang.String Principal_address = "http://localhost:8080/ExamesWebService/services/Principal";
    ...
    public servicos.Principal getPrincipal() throws javax.xml.rpc.ServiceException {
    ...
    public servicos.Principal getPrincipal(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            servicos.PrincipalSoapBindingStub _stub = new servicos.PrincipalSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (servicos.Principal.class.isAssignableFrom(serviceEndpointInterface)) {
                servicos.PrincipalSoapBindingStub _stub = new servicos.PrincipalSoapBindingStub(new java.net.URL(Principal_address), this);
                _stub.setPortName(getPrincipalWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://servicos", "PrincipalService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://servicos", "Principal"));
        }
